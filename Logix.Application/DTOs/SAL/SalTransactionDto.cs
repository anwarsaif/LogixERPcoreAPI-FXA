...
{
    public class SalTransactionDto
    {
        ...
        [StringLength(10)]
        [Required(ErrorMessage = "*")]
        public string? DueDate { get; set; } = DateTime.Now.ToString("yyyy/MM/dd", CultureInfo.InvariantCulture);
        [Required(ErrorMessage = "*")]
    ...
    {
        public SalTransactionVM()
        {
            SalTransactionDto = new SalTransactionDto();
            Items = new List<OpmTransactionsItemDto>();
            Locations = new List<OpmTransactionsLocationDto>();
            DetailsList = new List<OPMTransactionsDetailsDto>();
        }
        public SalTransactionDto SalTransactionDto { get; set; }

        public List<OpmTransactionsItemDto> Items { get; set; }
        public List<OpmTransactionsLocationDto> Locations { get; set; }
        public List<OPMTransactionsDetailsDto> DetailsList { get; set; }

    }
    public class SalTransactionEditVM
    {
        public SalTransactionEditVM()
        {
            SalTransactionEditDto = new SalTransactionEditDto();
            Items = new List<OpmTransactionsItemDto>();
            Locations = new List<OpmTransactionsLocationDto>();
            DetailsList = new List<OPMTransactionsDetailsDto>();
        }
        public SalTransactionEditDto SalTransactionEditDto { get; set; }
    ...
    public class UpdateProjectSALTransactionsDto
    {
