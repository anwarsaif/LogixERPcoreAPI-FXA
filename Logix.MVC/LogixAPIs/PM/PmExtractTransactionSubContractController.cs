...
{
    public class PmExtractTransactionSubContractController : BasePMApiController
    {
        ...
        public PmExtractTransactionSubContractController(IPMServiceManager pmServiceManager,
        ...
        public async Task<IActionResult> Add(PmExtractTransactionAddDto entity)
        {
            ...
            try
            {
                ...
                var items = await pmServiceManager.PmExtractTransactionSubContractService.Add(entity);
        ...
        public async Task<IActionResult> CreateACC(PmExtractTransactionACCCreateDto entity)
        {
            ...
            try
            {
                ...
                var items = await pmServiceManager.PmExtractTransactionSubContractService.CreateACC(entity);
        ...
        public async Task<IActionResult> Delete(long id)
        {
            try
            {
                ...
                var delete = await pmServiceManager.PmExtractTransactionSubContractService.Remove(id, 58);
                return Ok(delete);  
            }
            catch (Exception ex)
            {
...
*/
        ...
        public async Task<IActionResult> GetPMProjectsItemsByPMCodeItemCode(long ProjectCode ,string ProjectItemCode)
        {
            ...
            {
                if(ProjectCode==0)
                return Ok(await Result<PMExtractItemDto>.FailAsync($"اختر عقد المشروع"));
        ...
        public async Task<IActionResult> GetByIdForEdit(long Id)
        {
            ...
            try
            {
                ...
                var items = await pmServiceManager.PmExtractTransactionSubContractService.GetForEditById(Id);
        ...
        private async Task<IResult<DataTable>> Filter(PmExtractTransactionFilterDto filter)
        {
            ...
            var items = await pmServiceManager.PmExtractTransactionSubContractService.GetExtracts(filter);
            return items;
        }
