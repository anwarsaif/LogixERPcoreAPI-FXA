...
{
    // مكتبة المخرجات
    public class PMRPDeliverables2Controller : BasePMApiController
    {
        ...
        public PMRPDeliverables2Controller(IPMServiceManager pMServiceManager, IPermissionHelper permission, ILocalizationService localization)
        {
        ...
        {
            var chk = await permission.HasPermission(2023, PermissionType.Show);
