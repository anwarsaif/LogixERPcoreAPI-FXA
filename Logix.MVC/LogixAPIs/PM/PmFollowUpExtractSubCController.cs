...
{
    public class PmFollowUpExtractSubCController : BasePMApiController
    {
        ...
        public PmFollowUpExtractSubCController(IPMServiceManager pmServiceManager,
        ...
        private async Task<IResult<DataTable>> Filter(PmExtractTransactionFilterDto filter)
        {
            ...
            //   في حال كان موظف مشاريع تظهر فقط المشاريع الخاصة به
