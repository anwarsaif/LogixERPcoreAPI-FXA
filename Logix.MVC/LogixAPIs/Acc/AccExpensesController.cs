...
{
    public class AccExpensesController : BaseAccApiController
    {
        ...
        {
            var chk = await permission.HasPermission(73, PermissionType.Show);
            var chk2 = await permission.HasPermission(505, PermissionType.Show);
            ...
            try
            {
                var items = await accServiceManager.AccJournalMasterService.GetAllVW(x => x.FlagDelete == false && x.FacilityId == _session.FacilityId && x.DocTypeId == 2 && x.FinYear == _session.FinYear);
                if (items.Succeeded)
                {
        ...
        public async Task<IActionResult> Search(AccJournalMasterfilterDto filter)
        {
            ...
            try
            {
                ...
                var items = await accServiceManager.AccJournalMasterService.GetAllVW(x => x.FlagDelete == false
                  && x.FacilityId == _session.FacilityId && x.DocTypeId == 2 && x.FinYear == _session.FinYear
        ...
        [HttpPost("Add")]
        public async Task<IActionResult> Add(AccExpensesDto obj)
        {
            var chk = await permission.HasPermission(73, PermissionType.Add);
            var chk2 = await permission.HasPermission(505, PermissionType.Add);
            ...
            try
            {
                ...
                {
                    return Ok(await Result<AccExpensesDto>.FailAsync(localization.GetMessagesResource("dataRequire")));
                }
                var add = await accServiceManager.AccJournalMasterService.AddExpenses(obj);
                return Ok(add);
            }
            catch (Exception ex)
            {
                return Ok(await Result<AccExpensesDto>.FailAsync($"======= Exp in Acc Expenses add: {ex.Message}"));
            }
        }
        ...
        {
            var chk = await permission.HasPermission(73, PermissionType.Edit);
            var chk2 = await permission.HasPermission(505, PermissionType.Edit);
            ...
            try
            {
                if (!ModelState.IsValid)
                {
                    return Ok(await Result<AccExpensesMasterEditDtoVW>.FailAsync(localization.GetMessagesResource("dataRequire")));
                }
                obj.AccJournalMasterDto.DocTypeId = 2;
                var Edit = await accServiceManager.AccJournalMasterService.UpdateExpenses(obj);
                return Ok(Edit);
            }
            catch (Exception ex)
            {
                return Ok(await Result<AccExpensesMasterEditDtoVW>.FailAsync($"======= Exp in Acc Journal  edit: {ex.Message}"));
            }
        }
        ...
        {
            var chk = await permission.HasPermission(73, PermissionType.Delete);
            if (!chk)
            {
                return Ok(await Result.AccessDenied("AccessDenied"));
            }
        ...
        public async Task<IActionResult> GetByIdForEdit(long id)
        {
            try
            {
                ...
                {
                    var DetailesCredit = await accServiceManager.AccJournalDetaileService.SelectACCJournalDetailesCredit(id);
                    ...
                    var AccJournalMasterDto = new AccIncomeDto
                    {
                        ...
                        Amount = DetailesCredit.Data.Amount,
                        AmountWrite = DetailesCredit.Data.AmountWrite,
                        ...
                        cashOnhandId = DetailesCredit.Data.AccAccountId,
        ...
        #region "Reports Expenses "

        [HttpPost("RepExpensesSearch")]

        public async Task<IActionResult> RepExpensesSearch(AccJournalMasterfilterDto filter)
        {
            var chk = await permission.HasPermission(77, PermissionType.Show);
            if (!chk)
            {
                return Ok(await Result.AccessDenied("AccessDenied"));
            }
            ...
            try
            {
                ...
                //      return Ok(await Result<List<AccJournalMasterVw>>.SuccessAsync(final, ""));
                //  }
                var items = await accServiceManager.AccJournalMasterService.RepExpensesSearch(filter);
				return Ok(items);
            }
            catch (Exception ex)
            {
        ...
        #endregion "Reports Expenses "

        #region "Reports Expenses Details"



        [HttpPost("RepExpensesDetailsSearch")]
        public async Task<IActionResult> RepExpensesDetailsSearch(AccJournalDetailefilterDto filter)
        {
            var chk = await permission.HasPermission(1839, PermissionType.Show);
        ...
        #endregion "Reports Expenses Details""
    }
}
